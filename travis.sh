...
git clone https://github.com/DOMjudge/domjudge-scripts.git
cd ${HOME}/domjudge-scripts && git reset --hard 41a5d0281de7386e42d8e989e4811586891fbcb9
...
$CHECK_API -n -t30 http://admin:admin@localhost/domjudge/api/contests/demo
